package application.TLFCustom 
{
	...
	import flashx.textLayout.conversion.CustomFormatImporter;
	import flashx.textLayout.conversion.FlowElementInfo;
	import flashx.textLayout.conversion.ImportExportConfiguration;
	import flashx.textLayout.conversion.SingletonAttributeImporter;
	 ...
	 * @author Tao
	 */
	public class TextLayoutImporterV2 extends TextLayoutImporter 
	{
		
		public function TextLayoutImporterV2() 
		{
		...
		*/
		public static function get defaultConfiguration():ImportExportConfiguration
		{
			...
			if (!_defaultConfiguration)
			{
				...
				_defaultConfiguration.addIEInfo("img2", InlineGraphicElementV2, TextLayoutImPorterV2.parseInlineGraphic, TextLayoutExporter.exportImage);	
		...
		* @playerversion AIR 1.5
		...
		override public function createDivFromXML(xmlToParse:XML):DivElement
		{
		...
		override public override function createParagraphFromXML(xmlToParse:XML):ParagraphElement
		{
		...
		override public function createSubParagraphGroupFromXML(xmlToParse:XML):SubParagraphGroupElement
		{
		...
		override public function createTCYFromXML(xmlToParse:XML):TCYElement
		{
		 ...
		 */
		override public function createLinkFromXML(xmlToParse:XML):LinkElement
		{
		...
		override public function createInlineGraphicFromXML(xmlToParse:XML):InlineGraphicElement
		{				
		...
		override public override function createListFromXML(xmlToParse:XML):ListElement
		{
		...
		override public override function createListItemFromXML(xmlToParse:XML):ListItemElement
		{
		...
		override public function extractTextFormatAttributesHelper(curAttrs:Object, importer:TLFormatImporter):Object
		{
		...
		override public function createDictionaryFromXML(xmlToParse:XML):Dictionary
		{
		...
		override public function createListMarkerFormatDictionaryFromXML(xmlToParse:XML):Dictionary
		{
			var formatImporters:Array = [ _customFormatImporter ];
		...
		{
			var divElem:DivElement = TextLayoutImporterV2(importFilter).createDivFromXML(xmlToParse);
		...
		{
			var ilg:InlineGraphicElementV2 = TextLayoutImporterV2(importFilter).createInlineGraphicFromXML(xmlToParse);
