...
*/
package com.uiComponents.tableBar
{
	import com.uiComponents.events.TabBarEvent;
	import com.uiComponents.tableBar.tabBarClasses.TabButton;
     ...
     *
	 * @eventType com.uiComponents.events.TabBarEvent.ITEM_ROLL_OUT
     *
     * @see #event:itemRollOver
	 */
	[Event(name="itemRollOut", type="com.uiComponents.events.TabBarEvent")]
	
	/**
	 * Dispatched when the user rolls the pointer over an tab in the component.
     *
     * @eventType com.uiComponents.events.TabBarEvent.ITEM_ROLL_OVER
     *
     * @see #event:itemRollOut
	 */
	[Event(name="itemRollOver", type="com.uiComponents.events.TabBarEvent")]
     ...
     *
     * @eventType com.uiComponents.events.TabBarEvent.ITEM_CLICK
	 */
	[Event(name="itemClick", type="com.uiComponents.events.TabBarEvent")]
	...
	//--------------------------------------
		...
		private static const TAB_STYLES:Object = 
		{
			...
			overTextFormat:"overTextFormat",
			pressTextFormat:"pressTextFormat"
		};
	...
	//--------------------------------------
		 ...
		 * 返回当前选项卡里所有的按钮 
		 */		
		public function getAllBtns():Array
		{
			return buttons;
		}
